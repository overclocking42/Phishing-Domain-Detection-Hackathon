...
rf_versions = {
    ...
    'v8': RandomForestClassifier(max_features='log2', n_estimators=100, random_state=42),
    'v9': RandomForestClassifier(min_samples_split=2, n_estimators=100, random_state=42),
    'v10': RandomForestClassifier(min_samples_split=5, n_estimators=100, random_state=42)
}
